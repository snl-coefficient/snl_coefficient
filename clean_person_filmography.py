...
filmography_credits = filmography_credits[filmography_credits.year != 'nan-nan']
...
filmography_years.to_csv("is-cecily-there.csv", index=False)
...
print(filmography_done.shape[0])
