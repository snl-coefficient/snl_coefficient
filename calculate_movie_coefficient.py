...
with open("data/running_snl_movie_coefficient.csv", 'w') as f:
    writer = csv.writer(f)
    ...
    # now iterate over the roles dataframe
        ...
        if movie_coefficient == 0:
            print("problem here! ", "person_values: ", person_values, "sum_of_values: ", sum_of_values, "cast_count: ", cast_count)
...
#sorted_df = snl_movie_data.sort_values(by='movie_coefficient')
